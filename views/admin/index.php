    ...
    <div class="row">
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8">
                ...
                <dl>
                    <dt><a href='add_vug'><h3>Розрахунок витрат вуглекислоти</h3></a></dt>
                    <dd>Внесення даних норми витрат вуглекислоти (коефіцієнт для дроту зварювального та вуглекислоти)</dd>
                </dl>
